      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        <div className="p-6">
          ...
          {vendor.total_reviews > 0 && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
              <p className="text-sm text-yellow-800 font-secondary">
                <strong>Warning:</strong> This vendor has {vendor.total_reviews}{" "}
                review{vendor.total_reviews !== 1 ? "s" : ""}.
              </p>
            </div>
          )}
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={onConfirm}
              className="flex-1 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 font-secondary font-medium transition-colors"
            >
              Delete Vendor
            </button>
          </div>
