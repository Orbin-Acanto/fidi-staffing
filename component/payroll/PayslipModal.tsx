      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          <div className="grid grid-cols-2 gap-6">
            <div>
              <h3 className="text-xs font-secondary font-semibold text-gray-500 uppercase mb-2">
                Company
              </h3>
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                ...
                <p className="font-secondary font-medium text-gray-900">
                  {entry.periodType.charAt(0).toUpperCase() +
                    entry.periodType.slice(1).replace("-", " ")}
                </p>
              </div>
              <div>
                <p className="text-xs text-gray-500 font-secondary">
          ...
          {/* Earnings */}
          <div>
            <h3 className="text-sm font-secondary font-semibold text-gray-900 mb-3">
              Earnings
            </h3>
            <div className="border border-gray-200 rounded-lg overflow-hidden">
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-4 py-2 text-left text-xs font-secondary font-semibold text-gray-600">
                      Description
                    </th>
                    <th className="px-4 py-2 text-center text-xs font-secondary font-semibold text-gray-600">
                      Hours
                    </th>
                    <th className="px-4 py-2 text-center text-xs font-secondary font-semibold text-gray-600">
                      Rate
                    </th>
                    <th className="px-4 py-2 text-right text-xs font-secondary font-semibold text-gray-600">
                      Amount
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {entry.payType === "hourly" ? (
                    <>
                      <tr>
                        <td className="px-4 py-3 text-sm font-secondary text-gray-900">
                          Regular Hours
                        </td>
                        <td className="px-4 py-3 text-sm font-secondary text-gray-600 text-center">
                          {entry.regularHours}
                        </td>
                        <td className="px-4 py-3 text-sm font-secondary text-gray-600 text-center">
                          ${entry.hourlyRate}/hr
                        </td>
                        <td className="px-4 py-3 text-sm font-secondary text-gray-900 text-right">
                      ...
                      {entry.overtimeHours > 0 && (
                        <tr>
                          ...
                          <td className="px-4 py-3 text-sm font-secondary text-gray-600 text-center">
                            ${(entry.hourlyRate * 1.5).toFixed(2)}/hr
                          </td>
                          <td className="px-4 py-3 text-sm font-secondary text-orange-600 text-right">
                    ...
                    entry.events.map((event, idx) => (
                      <tr key={idx}>
                        ...
                        <td className="px-4 py-3 text-sm font-secondary text-gray-900 text-right">
                          {formatCurrency(entry.fixedRate)}
                        </td>
                      </tr>
                    ))
                  )}
                  ...
                  {entry.bonuses.map((bonus) => (
                    <tr key={bonus.id} className="bg-green-50">
                      <td className="px-4 py-3 text-sm font-secondary text-green-700">
                        {bonus.description}
                      </td>
                      <td className="px-4 py-3 text-sm font-secondary text-gray-600 text-center">
                        —
                      ...
                      <td className="px-4 py-3 text-sm font-secondary text-green-600 text-right">
                ...
                <tfoot className="bg-gray-50">
                  <tr>
                    <td
                      colSpan={3}
                      className="px-4 py-3 text-sm font-secondary font-semibold text-gray-900"
                    >
                      Gross Earnings
                    </td>
                    <td className="px-4 py-3 text-sm font-secondary font-bold text-gray-900 text-right">
                      {formatCurrency(entry.grossPay + entry.totalBonuses)}
                    </td>
                  </tr>
                </tfoot>
              </table>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-100">
                  <tr>
                    ...
                    <td className="px-4 py-3 text-sm font-secondary text-red-600 text-right">
                      -{formatCurrency(entry.taxWithholding)}
                    </td>
                  </tr>
                ...
                <tfoot className="bg-gray-50">
                  <tr>
                    <td className="px-4 py-3 text-sm font-secondary font-semibold text-gray-900">
                      Total Deductions
                    </td>
                    <td className="px-4 py-3 text-sm font-secondary font-bold text-red-600 text-right">
                      -
                      {formatCurrency(
                        entry.taxWithholding + entry.totalDeductions
                      )}
                    </td>
                  </tr>
                </tfoot>
        ...
        <div className="p-6 border-t border-gray-200 bg-gray-50 sticky bottom-0">
          <div className="flex items-center justify-between">
            <p className="text-xs text-gray-400 font-secondary">
              Generated on {new Date().toLocaleDateString()} • Payslip ID: PS-
